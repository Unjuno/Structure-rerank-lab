...
1. Add a BEIR summary file generated by CI.
2. Add rank movement reports for `vertical_vector_rerank`.
3. Improve vertical axis estimation beyond fixed structure types.
4. Add optional dense embedding backend later.
